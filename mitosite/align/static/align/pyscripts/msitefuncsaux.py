...
os.system("source /project/home17/whb17/public_html/django-framework/mitosite/align/static/align/shscripts/time.sh")	# run bash script. Full path given so accessable from any directory. Change later so not hard coded.